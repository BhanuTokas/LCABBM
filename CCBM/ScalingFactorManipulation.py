...
if __name__ == "__main__":
    ...
    c.diff_interface.pipe.vae.config.scaling_factor = 0.25
    ...
    recon = c.diff_interface.reconstruct_from_zT(z_i, zT, num_inference_steps=40, guidance_scale=8.0, eta=0.0, generator=gen)
    recon.save("outputs/reconstructed_from_zT.png")
    
    recon_1 = c.diff_interface.reconstruct_from_zT(z_i + (z_pos-z_neg)*scale, zT, num_inference_steps=40, guidance_scale=8.0, eta=0.0, generator=gen)
